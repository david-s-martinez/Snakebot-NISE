...
void setup()
{
  Serial.begin(115200);
  double w_body = 1.0;
  double w_limb_body = 3.0;
  for (int i = 0; i < NUMBER_MI_NEURONS; i++)
  {
    if (i == 0)
    {
      mi_neuron[i].a[0] = w_body;
      mi_neuron[i].a[7] = w_body;
      // mi_neuron[i].a[16] = w_limb_body;
    }
    else if (i == 7)
    {
      mi_neuron[i].a[18] = w_body;
      mi_neuron[i].a[7] = w_body;
      // mi_neuron[i].a[10] = w_limb_body;
    }
    else if (i == 8)
    {
      mi_neuron[i].a[0] = w_body;
      mi_neuron[i].a[11] = w_body;
      // mi_neuron[i].a[17] = w_limb_body;
    }
    else if (i == 15)
    {
      mi_neuron[i].a[18] = w_body;
      mi_neuron[i].a[11] = w_body;
      // mi_neuron[i].a[19] = w_limb_body;
    }
    else if (i >= 1 && i <= 6)
    {
      mi_neuron[i].a[18] = w_body;
    ...
    else if (i == 16)
    {
      ...
      mi_neuron[i].a[3] = w_limb_body;
      mi_neuron[i].a[4] = w_limb_body;
      mi_neuron[i].a[5] = w_limb_body;
      mi_neuron[i].a[6] = w_limb_body;
    }
    else if (i == 17)
    {
      mi_neuron[i].a[18] = w_body;
      mi_neuron[i].a[1] = w_body;
      mi_neuron[i].a[10] = w_limb_body;
      mi_neuron[i].a[11] = w_limb_body;
      mi_neuron[i].a[12] = w_limb_body;
      mi_neuron[i].a[13] = w_limb_body;
    }
    else if (i == 18)
    {
      mi_neuron[i].a[0] = w_body;
      mi_neuron[i].a[17] = w_body;
      mi_neuron[i].a[5] = w_limb_body;
      mi_neuron[i].a[6] = w_limb_body;
      mi_neuron[i].a[7] = w_limb_body;
      mi_neuron[i].a[8] = w_limb_body;
    }
    else if (i == 19)
    {
      mi_neuron[i].a[17] = w_body;
      ...
      mi_neuron[i].a[12] = w_limb_body;
      mi_neuron[i].a[13] = w_limb_body;
      mi_neuron[i].a[14] = w_limb_body;
      mi_neuron[i].a[15] = w_limb_body;
    }
  }
  delay(2000);
}
